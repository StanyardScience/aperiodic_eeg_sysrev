...
#             print(f"Iteration: {i}")
    ...
    elif which_figure_am_I == 'SVa' or which_figure_am_I == 'SVa' or which_figure_am_I == 'Sva' or which_figure_am_I == 'S5A' or which_figure_am_I =='S5a':
...
#             print(f"Iteration: {i}, m[i]: {m[i]}, col[i]: {col[i]}, type(col[i]): {type(col[i])}")
        ...
        print(f'Entry: {which_figure_am_I} is not in the preset list of 2a, 2b, 3a, 3b, SVA/SVa/Sva/S5A/S5a. Please verify the input')
